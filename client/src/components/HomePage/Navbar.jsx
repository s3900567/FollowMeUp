...
const Navbar = () => {
  ...
  return (
    <div className='mt-3 px-2 flex justify-between items-center w-full h-full'>
      ...
      <ul className={nav ? 'fixed left-0 top-0 w-[90%] h-full border-r border-[#FF8F6B] bg-[#EBEFFF] ease-in-out duration-700' : 'ease-in-out duration-600 fixed left-[-90%]'}>
  <h1 className='w-full text-3xl font-bold text-[#109CF1] m-8'>FOLLOW ME UP.</h1>
  <li className="px-6 p-4 border-b border-[#FF8F6B]"><a href='#products'>Products</a></li>
  <li className="px-6 p-4 border-b border-[#FF8F6B]"><a href='#customers'>Customers</a></li>
  <li className="px-6 p-4 border-b border-[#FF8F6B]"><a href='#about'>About</a></li>
  <li className="px-6 p-4 border-b border-[#FF8F6B]"><a href='#contact'>Contact</a></li>
